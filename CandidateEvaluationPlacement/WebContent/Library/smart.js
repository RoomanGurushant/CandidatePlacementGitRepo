...
function SmartAddRow(smartarropt) {
	...
	var j=0;
	var data ="";
	for(i=0;i<smartarropt.smartarr[0].key.length;i++){
		data = data + "<option value = "+i+"-"+smartarropt.smartarr[1].key[i]+">"+smartarropt.smartarr[0].key[i]+"</option>"	
		}
	smartarropt = data;
...
function SmartPopulateParam1(bool,count) {
    ...
    if(bool=="text") {
        ...
        bool_txt="<input name="+count+"_txt_value_1 id="+count+"_txt_value_1 onKeyup=\"toNumber('"+count+"_txt_value_1','');\" type=text class=\"form-control\" value='"+ x +"'size=30 Maxlength=7></input>";
        document.getElementById("booltxt"+count+"").innerHTML =bool_txt;
        ...
        bool_txt="<input name="+count+"_txt_value_1 id="+count+"_txt_value_1 type=text size=16   onmouseover=\"$('.datetimepicker').bootstrapMaterialDatePicker({ format : 'DD/MM/YYYY HH:mm',switchOnClick : true, clearButton: true });\" class='form-control datetimepicker' maxlength=16 >"
        document.getElementById("booltxt"+count+"").innerHTML =bool_txt;
...
function SmartPopulateParam2(line,count) {
    ...
    else if(line.value=="0-numeric" || line.value=="1-numeric" || line.value=="2-numeric" || line.value=="3-numeric" || line.value=="4-numeric" || line.value=="5-numeric")
    {
        ...
        line_txt="<input name="+count+"_txt_value_2 id="+count+"_txt_value_2 type=text  size=16 onmouseover=\"$('.datetimepicker').bootstrapMaterialDatePicker({ format : 'DD/MM/YYYY HH:mm',switchOnClick : true, clearButton: true });\" class='form-control datetimepicker' maxlength=16 >"
        document.getElementById("booltxt"+count+"").innerHTML =bool_txt+"&nbsp"+line_txt ;
