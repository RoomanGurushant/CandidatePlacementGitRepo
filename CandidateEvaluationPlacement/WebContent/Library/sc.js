...
function delete_jcitem(jcitem_id, jcitem_item_id){
    var jc_id = document.getElementById("txt_jc_id").value;
	...
	var gsttype=document.getElementById("txt_gst_type").value;
    showHint('jobcard-item-details.jsp?jcitem_id='+jcitem_id+'&gsttype='+gsttype+'&type='+item_type_id+'&jcitem_item_id='+jcitem_item_id+'&jc_location_id='+jc_location_id+'&jc_id='+jc_id+'&delete_jcitem=yes', 'jcitem_details');
...
var value = document.getElementById("txt_search").value;
    ...
    if(bool == true ){
  	    ...
  	    var gsttype=document.getElementById("txt_gst_type").value;
  	    var type="q="+ value + "&rateclass_id="+rateclass_id;
  	    var str = "123";
...
function ItemDetails(item_id, item_type_id, item_type,
		item_ticket_dept_id, item_name, qty, base_price,
		price, price_variable, disc, tax_id1,tax_id2,tax1,tax2,tax_name1,tax_name2, 
		item_serial, jcitem_item_serial, jcitem_id,current_qty, mode){
...
function Addjcitem(){
	var status = document.getElementById("txt_status").value;
    var jc_id = document.getElementById("txt_jc_id").value;
    var jctrans_type = document.getElementById("dr_jctrans_type").value;
    var rateclass_id = document.getElementById("txt_rateclass_id").value;
    ...
    var gsttype=document.getElementById("txt_gst_type").value;
		if(serial=='1' && (jcitem_item_serial=='' || jcitem_item_serial=='0') && item_ticket_dept_id=='0'){
			...
			showHint('../service/jobcard-item-details.jsp?jc_id='+jc_id+'&jcitem_item_id='+jcitem_item_id+'&item_ticket_dept_id='+item_ticket_dept_id
					+'&jc_location_id='+jc_location_id+'&jcitem_qty='+jcitem_qty+'&jcitem_item_serial='+jcitem_item_serial
					+ '&rateclass_id='+rateclass_id+'&jctrans_type='+jctrans_type 
					+'&jcitem_price='+jcitem_price+'&jcitem_discount='+jcitem_discount
					+'&jcitem_tax1='+jcitem_tax1+'&jcitem_tax_id1='+jcitem_tax_id1
					+'&jcitem_tax_rate1='+jcitem_tax_rate1+
					+'&jcitem_tax2='+jcitem_tax2+'&jcitem_tax_id2='+jcitem_tax_id2
					+'&jcitem_tax_rate2='+jcitem_tax_rate2+'&gsttype='+gsttype
					+ '&jcitem_total='+jcitem_total+'&gsttype='+gsttype
					+'&type='+item_type_id+'&rowcount=yes&add_jcitem=yes','jcitem_details');
	        }
			if(item_type_id=='0' || item_type_id!=''){
...
function Updatejcitem(){
    ...
    var jcitem_tax1=document.getElementById('item_tax1').innerHTML;
    var jcitem_tax2=document.getElementById('item_tax2').innerHTML;
//    var jcitem_tax3=document.getElementById('item_tax3').innerHTML;
    var jcitem_tax_id1=document.getElementById('txt_item_tax_id1').value;
    var jcitem_tax_id2=document.getElementById('txt_item_tax_id2').value;
//    var jcitem_tax_id3=document.getElementById('txt_item_tax_id3').value;
    var jcitem_tax_rate1=document.getElementById('txt_item_tax1').value;
    var jcitem_tax_rate2=document.getElementById('txt_item_tax2').value;
//    var jcitem_tax_rate3=document.getElementById('txt_item_tax3').value;
    var jcitem_total = document.getElementById('txt_item_total').value;
    var jcitem_item_serial = document.getElementById("txt_item_serial").value;
    var serial = document.getElementById("txt_serial").value;
	var item_type_id = document.getElementById("txt_item_type_id").value;
	...
	jcitem_tax1=parseFloat(jcitem_tax1).toFixed(2);
	jcitem_tax2=parseFloat(jcitem_tax2).toFixed(2);
//	jcitem_tax3=parseFloat(jcitem_tax3).toFixed(2);
	...
	if(serial=='1' && jcitem_item_serial=='' || jcitem_item_serial=='0'){
        ...
        showHint('jobcard-item-details.jsp?jc_id='+jc_id+'&jcitem_id='+jcitem_id
        		+'&gsttype='+gsttype +'&jctrans_type='+jctrans_type
        		+'&jcitem_item_id='+jcitem_item_id+'&item_ticket_dept_id='
        		+item_ticket_dept_id+'&jc_location_id='+jc_location_id+
        		'&rateclass_id='+rateclass_id+
        		'&jcitem_qty='+jcitem_qty+'&jcitem_item_serial='+
        		jcitem_item_serial+'&jcitem_price='+jcitem_price+
        		'&jcitem_discount='+jcitem_discount+'&jcitem_tax1='+jcitem_tax1+'&jcitem_tax_id1='+jcitem_tax_id1
				+'&jcitem_tax_rate1='+jcitem_tax_rate1+
				+'&jcitem_tax2='+jcitem_tax2+'&jcitem_tax_id2='+jcitem_tax_id2
				+'&jcitem_tax_rate2='+jcitem_tax_rate2
//				+'&jcitem_tax3='+jcitem_tax3+'&jcitem_tax_id3='+jcitem_tax_id3+'&jcitem_tax_rate3='+jcitem_tax_rate3
        			+'&jcitem_total='+jcitem_total+'&update_jcitem=yes','jcitem_details');
        	} if(item_type_id=='0' && item_type_id!=''){
        		setTimeout('AddConfiguredItems()',200);
        		}
		  }
